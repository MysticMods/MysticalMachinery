...
public class ModTiles {
  ...
  public static final RegistryObject<TileEntityType<StoredHeatGeneratorTile>> STORED_HEAD_GENERATOR = REGISTRY.registerTileEntity("stored_heat_generator", REGISTRY.tile(StoredHeatGeneratorTile::new, ModBlocks.STORED_HEAD_GENERATOR));
