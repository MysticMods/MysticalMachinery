...
public class BatteryRecipeBuilder {
  ...
  public BatteryRecipeBuilder(IItemProvider resultIn, int countIn) {
    this.result = resultIn.asItem();
    this.count = countIn;
  }

  public static BatteryRecipeBuilder shapedRecipe(IItemProvider resultIn) {
   ...
   */
  public static BatteryRecipeBuilder shapedRecipe(IItemProvider resultIn, int countIn) {
    return new BatteryRecipeBuilder(resultIn, countIn);
  }

  /**
   * Adds a key to the recipe pattern.
   */
  public BatteryRecipeBuilder key(Character symbol, Tag<Item> tagIn) {
   ...
   * Adds a key to the recipe pattern.
   */
  public BatteryRecipeBuilder key(Character symbol, IItemProvider itemIn) {
   ...
   * Adds a key to the recipe pattern.
   */
  public BatteryRecipeBuilder key(Character symbol, Ingredient ingredientIn) {
   ...
   */
  public BatteryRecipeBuilder patternLine(String patternIn) {
   ...
   */
  public BatteryRecipeBuilder addCriterion(String name, ICriterionInstance criterionIn) {
    this.advancementBuilder.withCriterion(name, criterionIn);
    return this;
  }

  public BatteryRecipeBuilder setGroup(String groupIn) {
    this.group = groupIn;
    return this;
  }
  ...
  public void build(Consumer<IFinishedRecipe> consumerIn, ResourceLocation id) {
    ...
    consumerIn.accept(new BatteryRecipeBuilder.Result(id, this.result, this.count, this.group == null ? "" : this.group, this.pattern, this.key, this.advancementBuilder, new ResourceLocation(id.getNamespace(), "recipes/" + this.result.getGroup().getPath() + "/" + id.getPath())));
  }
