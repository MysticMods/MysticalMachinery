...
import noobanidus.mods.mysticalmachinery.tiles.WaterFabricatorTile;
...
public class InfiniteWaterFabricatorBlock extends Block {
  ...
  public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
    ...
    tooltip.add(new TranslationTextComponent("mysticalmachinery.water_fabricator.tooltip").setStyle(new Style().setColor(TextFormatting.AQUA).setBold(true)));
  }
}
