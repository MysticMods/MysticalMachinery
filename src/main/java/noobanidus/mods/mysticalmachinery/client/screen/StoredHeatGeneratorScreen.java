...
import noobanidus.mods.mysticalmachinery.container.StoredHeatGeneratorContainer;

@OnlyIn(Dist.CLIENT)
public class StoredHeatGeneratorScreen extends ContainerScreen<StoredHeatGeneratorContainer> {
  private static final ResourceLocation guiTexture = new ResourceLocation(MysticalMachinery.MODID, "textures/gui/stored_heat_generator.png");
